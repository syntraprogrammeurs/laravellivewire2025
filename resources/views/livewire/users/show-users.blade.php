<div class="p-6">
    ...
    @if($showMessage)
        <div
            ...
            class="mb-4 p-4 border rounded relative {{ $messageClass }}"
        >
            <div class="flex items-center justify-between">
                ...
                <button
                    ...
                    class="{{ $messageClass }} focus:outline-none"
                >
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div class="flex items-center">
                            <input type="checkbox" wire:model.live="selectedAll" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
